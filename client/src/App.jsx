    ...
    const fetchAllData = async () => {
      try {
        if (activeCategory === "Humble Recommends") {
          ...
          // 2. Filter & Map
          const recommended = allDrinks
            .filter((item) =>
              humblePicks.some((pick) =>
            ...
            .map((item) => ({
              ...
              customDesc:
                humbleDescriptions[
                  Object.keys(humbleDescriptions).find((key) =>
          ...
          <div className="relative py-12 text-center px-4 w-full">
            ...
            >
              <h1 className="text-6xl md:text-8xl font-black tracking-tighter text-transparent bg-clip-text bg-linear-to-r from-white via-slate-200 to-slate-500 drop-shadow-[0_0_15px_rgba(255,255,255,0.3)]">
                "KYU PINNI HAI <br />
                <span className="text-transparent bg-clip-text bg-linear-to-r from-pink-500 via-purple-500 to-cyan-500 animate-pulse">
                  DARU?"
                </span>
              </h1>
            ...
            >
              ...
              >
                ...
                <div className="absolute top-0 left-0 p-6 z-10">
                  <div className="flex items-center gap-2 mb-2">
                    ...
                    <span className="text-blue-400 font-bold tracking-[0.2em] text-[10px] uppercase">
                      Curated Selection
                    </span>
                  </div>
              ...
              <div className="col-span-1 bg-slate-900/50 backdrop-blur-md rounded-3xl border border-white/10 p-8 flex flex-col justify-center relative overflow-hidden h-72 group">
                ...
                <h3 className="text-2xl font-bold text-white mb-3">
                  The GC Approved List{" "}
                </h3>
                <p className="text-slate-400 leading-relaxed mb-6 text-sm">
                  These are the bottles that made it to our Group Chat's Hall of
                  Fame.
                </p>
                <button
                  onClick={() => handleCategoryClick("Humble Recommends")}
          ...
          <div className="flex flex-col md:flex-row gap-6 justify-between items-end mb-10 border-b border-white/10 pb-6">
            <div>
              ...
              >
                {activeCategory === "Humble Recommends" ? (
                  ...
                  <span
                    className={`text-${categories.find((c) => c.id === activeCategory)?.color || "pink"}-500`}
                  >
                    {activeCategory}
                  </span>
                )}
              ...
              <p className="text-slate-400 mt-2 font-medium text-sm uppercase tracking-widest">
                {activeCategory === "Humble Recommends"
                  ? "Verified by The Boys • 100% Quality"
                  : `Menu • ${displayedProducts.length} Selections`}
              </p>
            </div>
            ...
            {activeCategory !== "Humble Recommends" && (
              <div className="flex items-center gap-3 bg-white/5 p-1 rounded-xl border border-white/10">
                ...
                >
                  <option value="lowToHigh" className="bg-black">
                    Price: Low to High
                  </option>
                  <option value="highToLow" className="bg-black">
                    Price: High to Low
                  </option>
                  <option value="ratingHighToLow" className="bg-black">
                    Rating: High to Low
                  </option>
                  <option value="ratingLowToHigh" className="bg-black">
                    Rating: Low to High
                  </option>
                </select>
              </div>
